...
//import "./styles/default" as MStyle
...
Item {
    ...
    */
    ...
    property int m_iLastMode: 2
    function setMode (mode) {
       // console.log("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$setMode3:" + keyboard.layoutType)
        ...
        if(0 === mode) {
            m_iLastMode = mode
            keyboard.layoutType = "numbers"
        }
        else if(1 === mode) {
            m_iLastMode = mode
            keyboard.layoutType = "digits"
        }
        else {
            m_iLastMode = mode
            keyboard.layoutType = "main"
            keyboard.locale = "en_GB"
        }
    }
