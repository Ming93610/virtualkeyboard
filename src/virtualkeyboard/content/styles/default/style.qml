...
//    }
    ...
    property Timer testTimer: Timer {
        ...
        running: false
        onTriggered: {
            CReadWriteColor.readColorFile()
            backgroundColor = CReadWriteColor.getBoardBackgroundColor()
            keyBackColor = CReadWriteColor.getKeyBackgroundColor()
            keyTextColor = CReadWriteColor.getKeyTextColor()

           // console.log("当前颜色:" +  keyTextColor)
        }
    }
